            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <Badge className={`${getStatusColor(termination.status)} border font-semibold px-2 py-1 text-xs ml-2 flex-shrink-0`}>
                    {termination.status}
                  </Badge>
                </div>
                ...
                <div className="space-y-2 text-xs text-slate-500">
                  ...
                  <div>Last modified {termination.lastModified}</div>
                </div>
